export const GUATEMALA_DATA: Record<string, string[]> = {
  "Alta Verapaz": ["Cobán", "Santa Cruz Verapaz", "San Cristóbal Verapaz", "Tactic", "Tamahú", "Tucurú", "Panzós", "Senahú", "San Pedro Carchá", "Santa María Cahabón", "Lanquin", "Chahal", "Fray Bartolomé de las Casas", "Santa Catalina La Tinta", "Raxruhá"],
  "Baja Verapaz": ["Salamá", "San Miguel Chicaj", "Rabinal", "Cubulco", "Granados", "El Chol", "San Jerónimo", "Purulhá"],
  "Chimaltenango": ["Chimaltenango", "San José Poaquil", "San Martín Jilotepeque", "Comalapa", "Santa Apolonia", "Tecpán", "Patzún", "Pochuta", "Patzicía", "Santa Cruz Balanyá", "Acatenango", "Yepocapa", "San Andrés Itzapa", "Parramos", "El Tejar"],
  ...
  "Sacatepéquez": ["Antigua Guatemala", "Jocotenango", "Pastores", "Santo Domingo Xenacoj", "Sumpango", "Ciudad Vieja", "San Miguel Dueñas", "Alotenango", "San Antonio Aguas Calientes", "Santa Catarina Barahona", "San Lucas Sacatepéquez", "Santa Lucía Milpas Altas", "Magdalena Milpas Altas", "Santa María de Jesús", "San Bartolomé Milpas Altas"],
  "San Marcos": ["San Marcos", "San Pedro Sacatepéquez", "San Antonio Sacatepéquez", "Comitancillo", "San Miguel Ixtahuacán", "Concepción Tutuapa", "Tacaná", "Sibinal", "Tajumulco", "Tejutla", "San Rafael Pie de la Cuesta", "Nuevo Progreso", "El Tumbador", "El Rodeo", "Malacatán", "Catarina", "Ayutla", "Ocos", "San Pablo", "El Quetzal", "La Reforma", "Pajapita", "Ixchiguán", "San José Ojetenam", "San Cristóbal Cucho", "Sipacapa", "Esquipulas Palo Gordo", "Río Blanco", "San Lorenzo"],
...
export const DEPARTAMENTOS = Object.keys(GUATEMALA_DATA);

export const EMPRESAS = [
  "Unicomer S.A.", "Elektra", "Tiendas MAX", "Servicios Industriales", "Grupo Monge", 
  "La Curacao", "Walmart Guatemala", "Paiz", "Despensa Familiar", "Sears Guatemala", 
  "Siman", "Distelsa", "RadioShack", "Office Depot", "Gollo", "Comaco", 
  "CEMACO", "Juguetón", "EPA", "Tigo", "Claro", "Banco Industrial", "Banrural", 
  "Pollo Campero", "McDonalds", "Farmacias Siman", "Farmacias Cruz Verde"
];